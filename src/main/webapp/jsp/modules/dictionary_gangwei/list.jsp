            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">岗位管理</li>
                        <li class="breadcrumb-item active">岗位列表</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    var tableName = "dictionary_gangwei";
    var pageType = "list";
    var searchForm = {key: ""};
    var pageIndex = 1;
    var pageSize = 10;

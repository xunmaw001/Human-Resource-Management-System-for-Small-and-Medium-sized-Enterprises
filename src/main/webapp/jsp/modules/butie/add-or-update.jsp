    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑离职退休费用</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑离职退休费用</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">离职退休费用信息</h3>
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="gangweiValue" name="gangweiValue" class="form-control"
                                               placeholder="岗位" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>工种</label>
                                        <input id="gongzhongValue" name="gongzhongValue" class="form-control"
                                               placeholder="工种" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>照片</label>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="money" name="money" class="form-control"
                                            onchange="moneyChickValue(this)" placeholder="费用金额">
                                 </div>
...
<script>
    ...
    // 查询列表
        ...
        function yonghuSelect() {
            //填充下拉框选项
            http("yonghu/page?page=1&limit=100&sort=&order=&flag=999", "GET", {}, (res) => {
                if(res.code == 0){

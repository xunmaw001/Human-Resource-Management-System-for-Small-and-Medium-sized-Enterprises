            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑工资</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                 ...
                                 <div class="form-group col-md-6">
                                     <label>薪资</label>
                                     <input id="xinziMoney" name="xinziMoney" class="form-control"
                                            onchange="xinziMoneyChickValue(this)" placeholder="薪资">
                                 </div>
                                 <div class="form-group col-md-6">
                                     <label>补贴金额</label>
                                     <input id="butieMoney" name="butieMoney" class="form-control"
                                            onchange="butieMoneyChickValue(this)" placeholder="补贴金额">
                                 </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function xinziMoneyChickValue(e){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#xinziMoney").val(ruleForm.xinziMoney);
        $("#butieMoney").val(ruleForm.butieMoney);
        $("#sumMoney").val(ruleForm.sumMoney);

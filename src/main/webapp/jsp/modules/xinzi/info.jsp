            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">工资登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xinziMoney" name="xinziMoney" class="form-control"
                                               v-model="ruleForm.xinziMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>总金额</label>
                                        <input id="sumMoney" name="sumMoney" class="form-control"
                                               v-model="ruleForm.sumMoney" readonly>
                                    </div>

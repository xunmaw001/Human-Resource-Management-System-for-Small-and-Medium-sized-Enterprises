                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                岗位
                                                <select name="gangweiTypesSelectSearch" style="width: 100px;" id="gangweiTypesSelectSearch" class="form-control form-control-sm"
                                            ...
                                            <label>
                                                工种
                                                <select name="gongzhongTypesSelectSearch" style="width: 100px;" id="gongzhongTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(myPhotoCell);
            ...
            //合同
        var myFileCell = document.createElement('td');
        if(item.myFile ==null || item.myFile == '' || item.myFile == 'null'){
                myFileCell.innerHTML = '没有下载文件';
        }else {
            var myFileFile = document.createElement('button');
                myFileFile.innerHTML = '下载';
            var myFileFileAttr = "download('" + item.myFile + "')"
                myFileFile.setAttribute('onclick',myFileFileAttr);
                myFileCell.appendChild(myFileFile);
        }
        row.appendChild(myFileCell);

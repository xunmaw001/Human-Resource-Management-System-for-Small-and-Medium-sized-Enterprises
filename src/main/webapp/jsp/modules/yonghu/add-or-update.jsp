                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>工种</label>
                                       <select id="gongzhongTypesSelect" name="gongzhongTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-6">
                                       <label>照片</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>合同</label>
                                        <input name="file" type="file" class="form-control-file" id="myFileupload">
                                        <label id="myFileName"></label>
                                        <input name="myFile" id="myFile-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>民族</label>
...
<script>
    ...
    function upload() {
        ...
        $('#myFileupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('myFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('myFileName').innerHTML = "上传成功!";
            }
        });
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationGongzhongtypesSelect(){
            var gongzhongTypesSelect = document.getElementById('gongzhongTypesSelect');
            if(gongzhongTypesSelect != null && gongzhongTypesOptions != null  && gongzhongTypesOptions.length > 0 ){
                for (var i = 0; i < gongzhongTypesOptions.length; i++) {
                    gongzhongTypesSelect.add(new Option(gongzhongTypesOptions[i].indexName,gongzhongTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(gongzhongTypesSelect != null && gongzhongTypesOptions != null  && gongzhongTypesOptions.length > 0 ) {
            for (var i = 0; i < gongzhongTypesOptions.length; i++) {
                if (gongzhongTypesOptions[i].codeIndex == ruleForm.gongzhongTypes) {//下拉框value对比,如果一致就赋值汉字
                        gongzhongTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                sexTypes: "性别不能为空",
                gangweiTypes: "岗位不能为空",
                gongzhongTypes: "工种不能为空",
                myPhoto: "照片不能为空",
                myFile: "合同不能为空",
                nation: "民族不能为空",
                politicsTypes: "政治面貌不能为空",
                birthplace: "籍贯不能为空",
                yonghuTypes: "人员状态不能为空",
            }
        }).form();
    }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationGongzhongtypesSelect();
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') != '管理员') {
            ...
            $('#gangweiTypesSelect').attr('style', 'pointer-events: none;');
            $('#gongzhongTypesSelect').attr('style', 'pointer-events: none;');

...
public class YonghuController {
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        //  }
            ...
            return R.error(511,"用户账户或者手机号或者编号或者身份证号重复");
        }
    }
    ...
    */
    ...
    public R update(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if("".equals(yonghu.getMyFile()) || "null".equals(yonghu.getMyFile())){
                yonghu.setMyFile(null);
        }
        if(yonghuEntity==null){
            //  String role = String.valueOf(request.getSession().getAttribute("role"));
            //  if("".equals(role)){
    ...
    */
    ...
    YonghuEntity yonghu = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("username", username));
        if(yonghu==null || !yonghu.getPassword().equals(password) || yonghu.getYonghuTypes()!=1) {
            return R.error("账号密码不正确或者您没有登录权限");
        }
